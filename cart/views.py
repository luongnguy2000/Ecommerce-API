    ...
    def post(self, request):
        ...
        try:
            if incomplete_cart:
                ...
                new_cart_product.product.add(product_obj)
                new_cart.subtotal += product_obj.selling_price
                new_cart.save()
            message ={'erorr':False, 'message':'Product added to cart', 'product_id':product_id}
            
        except Exception as e:
            print(e)
            message ={'erorr':True, 'message':'Product not added to cart', 'product_id':product_id}
